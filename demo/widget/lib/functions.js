...
var functions = {
    ...
    */
    fix_fixed_bottom_input: function(dom_selector, autocheck) {

        autocheck = autocheck || false;

        var dom_obj = $(dom_selector);
        if (dom_obj.length === 0)
            return;
        ...
        // console.log(isIphoneX, isMicroMessenger);
        ...
        // 监听focus
        dom_obj.on("focus", focus_handler);

        // 监听blur
        dom_obj.on("blur", blur_handler);
